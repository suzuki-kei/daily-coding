...
function print_array<T>(values: T[]): void
{
    if (is_sorted(values))
...
function is_sorted<T>(values: T[]): boolean
{
...
function quick_sort<T>(values: T[]): void
{
    quick_sort_range(values, 0, values.length - 1)
}

function quick_sort_range<T>(values: T[], lower: number, upper: number): void
{
