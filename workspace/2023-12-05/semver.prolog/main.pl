...
demonstration2 :-
    ...
    semver(Version, 1, 2, 3),
    semver_bump_comare_print(Version, semver_bump_major),
    semver_bump_comare_print(Version, semver_bump_minor),
    semver_bump_comare_print(Version, semver_bump_patch).

semver_bump_comare_print(Version, BumpVersion) :-
    call(BumpVersion, BumpedVersion, Version),
