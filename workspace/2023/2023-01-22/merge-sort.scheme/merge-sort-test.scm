...
(define test.merge-sort-merge
    (lambda ()
        ...
        (test* "#5" '(1 1) (merge-sort-merge '(1) '(1)))
        (test* "#6" '(1 1) (merge-sort-merge '() '(1 1)))
        (test* "#7" '(1 2) (merge-sort-merge '(1 2) '()))
        (test* "#8" '(1 2) (merge-sort-merge '(1) '(2)))
        (test* "#9" '(1 2) (merge-sort-merge '() '(1 2)))
        (test* "#10" '(1 2 3 4 5) (merge-sort-merge '(1 3 4) '(2 5)))
        (test-end)))
