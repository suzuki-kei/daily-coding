...
(define test.merge-sort-merge
    (lambda ()
        ...
        (test* "#4" '(1 2) (merge-sort-merge '(1 2) '()))
        (test* "#5" '(1 2) (merge-sort-merge '(1) '(2)))
        (test* "#6" '(1 2) (merge-sort-merge '() '(1 2)))
        (test* "#7" '(1 2 3) (merge-sort-merge '(1 2 3) '()))
        (test* "#8" '(1 2 3) (merge-sort-merge '(1 2) '(3)))
        (test* "#9" '(1 2 3) (merge-sort-merge '(1) '(2 3)))
        (test* "#10" '(1 2 3) (merge-sort-merge '() '(1 2 3)))
        (test-end)))
