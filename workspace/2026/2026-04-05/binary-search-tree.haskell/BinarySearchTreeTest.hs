...
parseNonEmptyTreeTests =
    testsFromArgumentExpectedPairs "parseNonEmptyTree" parseNonEmptyTree [
        tree0 ==> Nothing,
        tree1 ==> Just (InternalNode (nodeValue tree1) (nodeLeft tree1) (nodeRight tree1)),
        tree2 ==> Just (InternalNode (nodeValue tree2) (nodeLeft tree2) (nodeRight tree2)),
        tree3 ==> Just (InternalNode (nodeValue tree3) (nodeLeft tree3) (nodeRight tree3))]
...
fmapTreeTests ::
    Test
fmapTreeTests =
    testsFromActualExpectedPairs "fmap" [
        fmap (+1) tree0 ==>
            EmptyTree,
        fmap (+1) tree1 ==>
