...
def expand(expected_arguments_tuples):
    ...
    def make_expanded_methods(parameterized_method):
        return [
            make_expanded_method(parameterized_method, expected_arguments_tuple, index)
            for index, expected_arguments_tuple in enumerate(expected_arguments_tuples)
        ]

    def make_expanded_method(parameterized_method, expected_arguments_tuple, index):
        expanded_method = lambda self: parameterized_method(self, *expected_arguments_tuple)
