...
void insertion_sort(int *array, int n)
{
    for (int sorted_size = 1; sorted_size < n; sorted_size++)
    {
        int insertion_index = sorted_size;
        int insertion_value = array[sorted_size];

        while (1 <= insertion_index && insertion_value < array[insertion_index - 1])
        {
