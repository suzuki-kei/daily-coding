...
void demonstration_with_partition(const char *label, FnPartition partition);
...
void demonstration(void)
{
    demonstration_with_partition("partition 2-way", partition_2way);
    demonstration_with_partition("partition 3-way", partition_3way);
}
