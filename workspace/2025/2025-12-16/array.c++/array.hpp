...
class Array
{
    ...
    private:
        static const std::size_t compute_initial_capacity(std::size_t minimum_capacity)
        {
        ...
        static const std::size_t compute_initial_capacity(const Array *source, std::size_t minimum_capacity)
        {
            if (source == nullptr)
