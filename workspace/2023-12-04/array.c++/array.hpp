...
private:
    Array(std::size_t minimum_capacity, const Array *source)
        : m_size(0),
          m_capacity(std::max(source == NULL ? 0 : source->m_size, minimum_capacity)),
